...
if __name__ == "__main__":
    ...
    section1.add_waypoints_with_dt([
        (1.25, 0.5, 1.0, set_time_step), # 1
        (1.0, 0.8, 1.1, set_time_step*0.75), # 2
        (0.7, 0.8, 1.1, set_time_step*0.75), # 2
        (0.4, 0.5, 1.2, set_time_step), # 3
        (1.0, 0.0, 1.0, set_time_step), # 4
        (1.25, -0.5, 0.9, set_time_step*1.25), # 5
        (1.0, -0.8, 0.8, set_time_step*1.25), # 6
        (0.4, -0.5, 0.7, set_time_step*1.25), # 7
        (0.6, 0.5, 0.8, set_time_step), # 8
        (0.5, 0.7, 0.9, set_time_step*1.25), # 9
        (0.25, 0.5, 1.0, set_time_step*1.5), # 10
        (0.8, -0.5, 1.1, set_time_step*1.5), # 11
    ], start_time=0.0)
    ...
    section2.add_waypoints_with_dt([
        (0.3, -0.75, 1.0, set_time_step*factor*factor2), # 12
        (-0.1, -0.75, 1.0, set_time_step*factor*factor2), # 13
        (-0.4, -0.5, 1.0, set_time_step*factor*factor2), # 14
        (-1.0, -0.1, 1.15, set_time_step*factor), # 15
        (-1.35, -0.5, 1.3, set_time_step*factor), # 16
        (-1.0, -0.8, 1.2, set_time_step*factor), # 17
        (-0.4, -0.5, 1.0, set_time_step*factor), # 18
        (-0.15, -0.35, 0.95, set_time_step*factor), # 19
        (-0.4, 0.25, 0.7, set_time_step*factor), # 20
        (-0.75, 0.25, 0.6, set_time_step*factor), # 21
        (-1.0, 0.25, 0.7, set_time_step*factor*factor2), # 22
        (-1.3, 0.0, 1.0, set_time_step*factor*factor2), # 23
        (-1.0, -0.2, 1.2, set_time_step*factor), # 24
        (-0.25, -0.25, 1.25, set_time_step*factor),  # 25
        (0.3, 0.5, 1.1, set_time_step*factor*1.5), # 26
        (0.0, 0.75, 1.0, set_time_step*factor), # 27
    ], start_time=0.0)
    ...
    section3.add_waypoints_with_dt([
        (-1.0, 1.0, fixed_z, set_time_step*factor*factor2), # 28
        (-1.5, 0.5, fixed_z, set_time_step*factor), # 29
        (-1.5, -0.5, fixed_z, set_time_step*factor*factor2), # 30
        (-1.0, -1.0, fixed_z, set_time_step*factor), # 31
        (1.0, -1.0, fixed_z, set_time_step*factor*factor2), # 32
        (1.5, -0.5, fixed_z, set_time_step*factor), # 33
        (1.5, 0.5, fixed_z, set_time_step*factor), # 34
    ], start_time=0.0)
