            ...
            if seed_dir.is_dir():
                try:
                    ...
                    if seed in seeds:
                        ...
                        if logs_dir.exists():
                            ep_length = load_from_log_file(logs_dir / 'ep_length.log')[3]
                            ep_return = load_from_log_file(logs_dir / 'ep_return.log')[3]
                            ep_return_std = load_from_log_file(logs_dir / 'ep_return_std.log')[3]
                            rmse = load_from_log_file(logs_dir / 'rmse.log')[3]
                            x, rmse_std = load_from_log_file(logs_dir / 'rmse_std.log')[1, 3]
