...
for ALGO in "${ALGOS[@]}"; do
    ...
    if [ "${ALGO}" == 'ppo' ]; then
        ...
        # {x, x_dot, y, y_dot, z, z_dot, phi, theta, psi, phi_dot, theta_dot, psi_dot, force_motor, T_c, R_c, P_c, Y_c}
        Q_WEIGHTS=(
            # "10.0,0.1,10.0,0.1,10.0,0.1,0.1,0.1,3.0,0.001,0.001,0.001,0.001,0.01,0.01,0.01,0.01"
            # "6.0,0.1,6.0,0.1,6.0,0.1,0.1,0.1,0.1,0.001,0.001,0.001,0.001,0.01,0.01,0.01,0.01"
